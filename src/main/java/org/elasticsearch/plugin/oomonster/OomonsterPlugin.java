...
public class OomonsterPlugin extends Plugin {

    private final Settings settings;

    public OomonsterPlugin(Settings settings) {
        this.settings = settings;
    }

    @Override
    public String name() {
        return "jvm-oomonster";
    }
    ...
    /**
     * Module decalaring some oomonster configuration and a _cat action that uses
     * it.
     */
    public static class ConfiguredExampleModule extends AbstractModule {
        ...
        protected void configure() {
          ...
          catActionMultibinder.addBinding().to(OomCatAction.class).asEagerSingleton();
        }
    }
}
